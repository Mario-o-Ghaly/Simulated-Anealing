...
int main(){
    ...
    // ofstream csv;
    // string filepath = "di.txt";
    // string csv_name = "di_TWL_vs_CoolingRate.csv";
    ...
    //     csv_name[1] = i;
    //     csv.open(csv_name);
    //     csv << "cooling rate, TWL\n";
    //     while(cooling_rate < 1){
    //         netlist mynet = parse_netlist(filepath);
    //         random_placement(mynet);
    //         int res = SA(mynet, cooling_rate);
    //         csv << cooling_rate << "," << res << "\n";
    //         cooling_rate+=0.05;
    //     }
    //     csv.close();
    //     i++;
